...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/costaalv/discovering-chaos/blob/main/notebooks/10_conditions_for_chaos.ipynb).
...
The upper plot materialises the first pillar: the dynamic reading of the system, in which the passage from an unstable regime
to a regime of stabilised fluctuations can be observed.
...
> without a natural scale, there is no stable stage;
> without a stable stage, there are no dominant fluctuations;
> without dominant fluctuations, there is no observable universality.
...
[$\gets$ Previous Chapter](./09_logarithmic_scale.md) | [Contents](../../index.md) | [Next Chapter $\to$](./11_eigenvector_anatomy.md)
