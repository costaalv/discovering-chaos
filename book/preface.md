...
We do not tune parameters to obtain appealing plots.
We do not introduce external hypotheses.
...
This book **does not** propose a new theory of numbers.
It **does not** introduce conjectures to be proved.
It **does not** replace formal textbooks in mathematics or mathematical physics.
...
* secondary-school students with a genuine interest in mathematics or physics;
* undergraduates who wish to see beyond formulae;
* teachers seeking new ways to present deep concepts;
* readers who enjoyed books such as *The Music of the Primes* and wish to go a little further.
...
Because discovering chaos in numbers is not about finding disorder.
It is about learning **where — and how — order chooses to reveal itself**.
...
Without execution, the book remains incomplete.
With it, the statements cease to be narrative and become observable records.
...
* an arithmetic signal is constructed;
* an operator is applied;
* the scale of observation is changed;
* and the resulting spectrum is actually computed.
...
The time invested in this practice is not a diversion from the text.
It is the path through which the text becomes complete.
